  ...
  return (
    <section className={classNamesHelper('letter-page', className)}>
      ...
      <p className="letter-page__paragraph">
        ...
        Swedish), it has never crossed my mind that one day I will be learning languages that would
        ...
        <b>a mentor and speaker at the events</b>.
      </p>
      <p className="letter-page__paragraph">
        ...
        lifelong journey and have a repertoire of learning strategies and thinking routines that
        help us effectively improve our mindset and skills. I have contributed on numerous occasions
        at Arbor Networks and FooCoding by using learning strategies to help us learn and improve
        together.
      </p>
      <p className="letter-page__paragraph">
        ...
        the end of June. The course has deepened my knowledge and practical skills in{' '}
        <b>React.js, JavaScript, Node.js, HTML, CSS and Git</b>.
      </p>
      <p className="letter-page__paragraph">
